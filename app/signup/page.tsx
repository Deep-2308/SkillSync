          ...
          <Card className="card-shimmer">
            <CardContent className="pt-8 pb-6 px-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" className="bg-transparent border-border hover:border-primary/30 hover:bg-primary/5 text-xs" onClick={() => handleOAuthSignup("google")} type="button" disabled={loading}>
                ...
                <Button variant="outline" className="bg-transparent border-border hover:border-primary/30 hover:bg-primary/5 text-xs" onClick={() => handleOAuthSignup("facebook")} type="button" disabled={loading}>
